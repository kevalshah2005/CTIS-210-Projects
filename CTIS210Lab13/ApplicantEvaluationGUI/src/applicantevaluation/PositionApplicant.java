...
public class PositionApplicant {
    ...
    public boolean analyzeApplicant6() {
        boolean accept;
        /*
            I'm going to do a modified version of method 5. I want to value general 
            academic performance somewhat, so I'm going to value GPA a little. Adv 
            Computer Programming is also very important, so I will value that as much 
            as algorithms. Finally, I will value the four programming classes I 
            care about a little more (84 -> 88). This gets me down to around 5-10%, 
            which is the range I want as I think around a thousand candidates is a 
            good number to go through, especially with candidates as qualified as these.
        */
        accept = ((algorithms >= 90) && (advCompProg >= 90) && ((introCompProg + advCompProg + databaseSystems + algorithms) / 4) > 88) && (gpa >= 80); 
        
        return accept;
    }
    
    // implements specification 3
